...
3. **final-teams**：2025 年重製版 Teams / Web 自動登入應用
   - 倉庫 URL：https://github.com/RheC1e/final-teams
...
> **Final Teams 新應用**：已於 Entra ID 建立，Client ID / Redirect URI 等資訊確認後請同步補入（含 Vercel 網域、Application ID URI、Teams manifest 參數）。
